...
export const FEATURED_FIGURES = [
  ...
  },
  {
    ...
    scope: '19 matched semester colleges and 9 UC campuses',
  ...
  },
  {
    ...
    metric: '+15.3',
    metricLabel: 'modeled replacement units for transfer degree holders',
    title: 'Modeled replacement coursework',
    question: 'How many associate-degree units may need to be replaced after transfer?',
    scope: '19 matched semester colleges and 9 UC campuses',
