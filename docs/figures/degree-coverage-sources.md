...
- Unrestricted elective ×1 / 4u (team decision 2026-07-21): the hand-authored requirements previously totaled 177u. The remaining capacity is represented as one normal 4-unit class rather than a synthetic 3-unit fraction; it is assumed satisfiable with UC-transferable CC coursework within the 105-quarter-unit transfer cap. The resulting modeled program totals **181u**, which legitimately sits one unit above the 180-unit graduation floor.
- Notes: requires Differential Equations (MATH 33B) — atypical for CS. No chemistry. School unit rule: 180–185 min / 213 max; `total_units` remains the 180-unit graduation floor while the modeled requirements total 181u.
...
- Unrestricted elective ×1 / 4u (team decision 2026-07-21): the hand-authored requirements previously totaled 176u. One normal 4-unit class fills that remaining capacity and is assumed satisfiable with UC-transferable CC coursework within the 105-quarter-unit transfer cap. The resulting modeled program total is **180u**, exactly matching the graduation minimum.
