...
export default function DocHead({ doc, assistUrl, sub, showAssist = true }) {
  return (
    <div className='surface-card px-5 py-5 flex items-start gap-3.5'>
      <div className='min-w-0'>
        <h2 className='text-stat tracking-[-.012em] break-words'>{doc.major}</h2>
        <div className='mt-1 flex items-center gap-2 text-caption ink-muted flex-wrap'>
