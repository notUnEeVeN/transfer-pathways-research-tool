...
describe('AsDegreeSchoolView', () => {
  it('renders coverage, units, courses, and the catalog source', () => {
    ...
    expect(screen.getByText('College-defined degree')).toBeInTheDocument()
    expect(screen.getByRole('tab', { name: 'Local A.S.' })).toHaveAttribute('aria-selected', 'true')
  ...
  it('shows a degree selector and switches when a college has several degrees', () => {
    ...
    fireEvent.click(screen.getByRole('tab', { name: 'A.S.-T' }))
  ...
  it('can isolate one degree type and suppress its repeated title', () => {
    ...
    expect(screen.queryByRole('tab', { name: 'Local A.S.' })).not.toBeInTheDocument()
    expect(screen.getByRole('tab', { name: 'A.S.-T' })).toHaveAttribute('aria-selected', 'true')
  ...
  it('shows every allowed overlapping degree type and clearly identifies the active kind', () => {
    ...
    expect(screen.getByText('Other college-defined degree')).toBeInTheDocument()
