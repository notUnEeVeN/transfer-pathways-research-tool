...
export function buildTaskHistoryAiBriefing(tasks = [], options = {}) {
  return [
    ...
    '1. True activity log (Monday-Sunday, preserving Week 1, Week 2, and later labels).',
    '2. Timesheet record (Sunday-Saturday, including daily and weekly totals).',
    '3. Hour-allocation notes (paired moved-from/received-by rows with actual date, reporting date, hours, and reason).',
