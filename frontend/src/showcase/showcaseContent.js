...
export const SHOWCASE_FINDINGS = [
  ...
  },
  {
    ...
    status: 'Live measure',
    metric: 'Two scopes',
    title: 'An associate degree fulfills different shares of the full and lower-division bachelor’s plans',
    description: 'The live comparison asks how much of the receiving bachelor’s requirements is fulfilled by each associate degree. One view includes the complete four-year plan; the other excludes upper-division and university-only work.',
    question: 'With an associate degree completed, what percentage of the bachelor’s requirements is already fulfilled?',
    scope: 'Associate degrees by receiving campus',
    method: 'Applies one feasible associate-degree plan to the receiving graduation model, then divides fulfilled requirement units by either all modeled units or only transferable and breadth units.',
    preview: 'paired-degrees',
    actionLabel: 'Explore degree credit by college',
    liveNote: 'Use the requirement-scope control to separate the complete four-year comparison from the lower-division comparison.',
  },
]
...
export const DEGREE_COMPARISON = [
  {
    ...
    colleges: 'Complete four-year graduation model',
    creditRate: 'Live',
    extraUnits: 'Includes university-only work',
  },
  {
    label: 'Lower-division requirements',
    colleges: 'Transferable and breadth tiers only',
    creditRate: 'Live',
    extraUnits: 'Excludes upper division',
  },
]
...
export const LIMITATIONS = [
  ...
  'The degree-credit denominator is the selected bachelor’s requirement scope; elective application is limited to documented university capacity.',
...
export const FEATURED_FIGURES = [
  ...
  },
  {
    ...
    star: 'Two views',
    starLabel: 'complete bachelor’s plan and lower-division requirements',
    claim: 'The receiving degree—not the associate degree—sets the completion denominator.',
    blurb: 'Each cell asks what percentage of the bachelor’s requirements is fulfilled by the selected associate degree. Switch between the complete four-year plan and the lower-division work a community college can actually complete.',
    method: 'Applies the associate degree once to articulated courses, general education or breadth, and documented elective room in the receiving graduation model.',
    formula: {
      expression: 'completion = bachelor’s requirement units fulfilled by the associate degree ÷ bachelor’s requirement units in scope',
      grain: 'One value per associate degree × UC program.',
      watchFor: 'The full scope includes upper-division work that a community college cannot complete. The lower-division scope excludes the nontransferable tier. A unit counts once even when it could satisfy two requirements.',
    },
  ...
  },
  {
    ...
    blurb: 'This companion view starts from the associate degree and counts how many of its units remain unapplied. The local degree leaves 22.4 units to replace; the transfer degree leaves 15.3. Darker cells are the college and campus pairs where the most work is repeated.',
    ...
    formula: {
      ...
      grain: 'One value per associate degree × UC program.',
      watchFor: 'This retains associate-degree units as its denominator, so it is a separate companion accounting from Figure 3’s bachelor’s-requirement percentage. It is a modeled burden, not observed student time to degree.',
    },
