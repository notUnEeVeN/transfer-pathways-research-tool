...
describe('PaperGate (four moments)', () => {
  ...
  it('switches basis: the ledger re-populates and moment-4 lines change', () => {
    ...
    expect(screen.getByText('27–30-POINT GAP')).toBeInTheDocument()
  ...
  it('separates access movement from the contracting rich-poor gap', () => {
    ...
    expect(gap.textContent).toContain('range across two evidence checks')
    expect(gap.textContent).toContain('49-POINT GAP')
    expect(gap.textContent).toContain('19–23-POINT GAP')
