 ...
 * agreement's cheapest path, what's lost, and (with ref_tuition curated) what
    ...
    return (
      <Stack gap='section'>
        ...
        <EmptyState
          ...
          description='This analysis compares curated associate-degree course lists (curation_assoc_degrees) against each matching agreement. Add degrees via the curation API — and per-credit tuition in the ref_tuition table for cost estimates — and rows appear here automatically.'
        />
      </Stack>
    )
  }
        ...
        <StatStrip
          tiles={[
            ...
            ...(hasCosts
              ...
              : [{ label: 'Est. lost cost', value: '—', sub: 'add ref_tuition rows to cost the loss' }]),
          ]}
        />
      </div>
